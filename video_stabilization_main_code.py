...
cp = cv2.VideoCapture('D:\\MINI PROJECT\\git\\Video-Stabilization-using-OpenCV-master\\Video-Stabilization-using-OpenCV-master\\video.mp4')
...
# Try doing 2*width
out = cv2.VideoWriter('D:\\MINI PROJECT\\git\\Video-Stabilization-using-OpenCV-master\\Video-Stabilization-using-OpenCV-master\\video_out',0x7634706d, fps, (width, height))
